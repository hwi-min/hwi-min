...
* **🎓 Education:** 
    ...
    * **Samsung Software AI Academy for Youth (SSAFY)** | AI & Data Track — Focused on data engineering, AI Agent, Langchain, LangGraph and system pipeline design.
* **🔬 Experience:**
...
* **삼성 청년 SW AI 아카데미 (SSAFY) 특화(핀테크) 프로젝트 우수상 (1등)**
    * [아꾸뱅꾸: 아이들의 주도적인 소비습관 형성을 만드는 나만의 핀테크 앱](https://github.com/akku-bank)
* **삼성 청년 SW AI 아카데미 (SSAFY) 1학기 관통 프로젝트최우수상 (1등)**
    * [gAemI-AI: 개인 맞춤형 주식 투자 리포트 플랫폼](https://github.com/gAemI-AI/gAemI-AI) 
